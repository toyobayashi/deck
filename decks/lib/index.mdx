...
<Step subtitle="jest.config.js - test/index.test.ts">
...
<Step subtitle="防止报名冲突，加上你自己的 scope，注册好 npm 后，npm publish">
...
```json 
{
  ...
  "version": "1.0.0",
  "description": "Rust Option for TypeScript/JavaScript",
  "scripts": {
    "build": "...",
    "test": "jest"
  },
...
<Step subtitle="Node.js CommonJS 入口">
...
配置：[https://github.com/toyobayashi/deck/tree/dev/decks/lib/package](https://github.com/toyobayashi/deck/tree/dev/decks/lib/package)

源码：[https://github.com/toyobayashi/rust-enum](https://github.com/toyobayashi/rust-enum)
