...
theme.styles.CodeSurfer.tokens['macro-name'] = { color: 'rgb(74, 156, 179)' }
theme.styles.CodeSurfer.tokens['directive'] = { color: 'rgb(197, 134, 192)' }
theme.styles.CodeSurfer.tokens['directive-hash'] = { color: 'rgb(197, 134, 192)' }
