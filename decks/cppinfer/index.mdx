...
```cpp 7:9,16:20 subtitle="auto 同理"
template <typename T>
void Fn6(T&& param) {
  /* ... */
}
...
```cpp subtitle="右值引用是左值！"
#include <iostream>

void TellMeRef(int& a) {
  std::cout << "TellMeRef(int&)\n";
}
...
```cpp subtitle="std::forward<T> 完美转发"
#include <iostream>
#include <utility>
